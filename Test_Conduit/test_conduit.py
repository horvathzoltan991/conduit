...
class TestConduit(object):
    ...
    def test_sign_up(self):
        ...
        error_msg = WebDriverWait(self.browser, 30).until(
    ...
    def test_login(self):
        ...
        profile_btn = WebDriverWait(self.browser, 30).until(
    ...
    def test_display_list(self):
        login(self.browser, test_data['valid_email'], test_data['valid_password'])
        ipsum_tag = WebDriverWait(self.browser, 30).until(EC.presence_of_element_located(
            (By.XPATH, '//div[@class="sidebar"]/div[@class="tag-list"]/a[text()="ipsum"]')))
        ipsum_tag.click()
        time.sleep(1)
        articles = WebDriverWait(self.browser, 30).until(
    ...
    def test_pagination(self):
        login(self.browser, test_data['valid_email'], test_data['valid_password'])
        page_links = WebDriverWait(self.browser, 30).until(
    ...
    def test_create_new_article(self):
        ...
        published_article_title = WebDriverWait(self.browser, 30).until(
    ...
    def test_update_profile_pic(self):
        ...
        update_msg = WebDriverWait(self.browser, 30).until(
            EC.presence_of_element_located((By.XPATH, '//div[@class="swal-title"]')))
    ...
    def test_logout(self):
        login(self.browser, test_data['valid_email'], test_data['valid_password'])
        logout(self.browser)
        sign_in_btn = WebDriverWait(self.browser, 30).until(
